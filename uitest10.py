...
class App:
    ...
    def create_widgets(self):
        ...
        self.btn_frame.pack(side=tk.BOTTOM, fill=tk.X, pady=5, padx=10)

        save_btn = tk.Button(self.btn_frame, text="Save", command=self.save_schema, width=12, height=2)
        save_btn.pack(side=tk.LEFT, padx=5)

        generate_btn = tk.Button(self.btn_frame, text="Generate", command=self.start_generation, width=12, height=2)
        generate_btn.pack(side=tk.LEFT, padx=5)

        reset_btn = tk.Button(self.btn_frame, text="Reset", command=self.reset_text, width=12, height=2)
