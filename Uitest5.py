...
class App:
    ...
    def create_widgets(self):
        ...
        import_icon = tk.BitmapImage(data='''#define im_width 16
#define im_height 16
static char im_bits[] = {
 0x00, 0x00, 0x3C, 0x3C, 0x7E, 0x7E, 0x66, 0x66, 0x66, 0x66, 0x7E, 0x7E,
 0x3C, 0x3C, 0x00, 0x00 };''')
        edit_icon = tk.BitmapImage(data='''#define ed_width 16
#define ed_height 16
static char ed_bits[] = {
 0x00, 0x00, 0x3C, 0x3C, 0x7E, 0x7E, 0x66, 0x66, 0x66, 0x66, 0x7E, 0x7E,
 0x3C, 0x3C, 0x00, 0x00 };''')
        link_icon = tk.BitmapImage(data='''#define ln_width 16
#define ln_height 16
static char ln_bits[] = {
 0x00, 0x00, 0x3C, 0x3C, 0x7E, 0x7E, 0x66, 0x66, 0x66, 0x66, 0x7E, 0x7E,
 0x3C, 0x3C, 0x00, 0x00 };''')
        download_icon = tk.BitmapImage(data='''#define dl_width 16
#define dl_height 16
static char dl_bits[] = {
 0x00, 0x00, 0x3C, 0x3C, 0x7E, 0x7E, 0x66, 0x66, 0x66, 0x66, 0x7E, 0x7E,
 0x3C, 0x3C, 0x00, 0x00 };''')
