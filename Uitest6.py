...
class App:
    ...
    def create_widgets(self):
        ...
        self.text_area = scrolledtext.ScrolledText(main_frame, wrap=tk.WORD, width=60, height=20)
        ...
        generate_btn = tk.Button(btn_frame, text="Generate", command=self.generate_classes, width=12, height=2)
        generate_btn.pack(side=tk.LEFT, padx5)
