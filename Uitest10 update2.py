...
class App:
    ...
    def create_widgets(self):
        ...
        self.frames["MainScreen"] = tk.Frame(container)
        self.frames["LoadingScreen"] = tk.Frame(container)

        for frame in self.frames.values():
            frame.grid(row=0, column=0, sticky='nsew')

        self.create_main_screen(self.frames["MainScreen"])
        self.create_loading_screen(self.frames["LoadingScreen"])
    ...
    def create_loading_screen(self, frame):
